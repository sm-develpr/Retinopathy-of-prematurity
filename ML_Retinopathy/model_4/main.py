...
class RetinalModel(nn.Module):
    def __init__(self, num_classes=NUM_CLASSES):
        ...
        # Модуль для обработки дополнительных признаков
        self.feature_processor = nn.Sequential(
            nn.Linear(4, 64),  # 3 числовых + 1 категориальный признак
            nn.BatchNorm1d(64),
            nn.ReLU(),
            nn.Dropout(0.3),
            nn.Linear(64, 128),
        ...
        self.classifier = nn.Sequential(
            nn.Linear(in_features + 128, 512),  # Объединяем CNN-фичи и дополнительные фичи
            nn.BatchNorm1d(512),
            nn.ReLU(),
            nn.Dropout(0.5),
...
Эпоха 1/30
Train Loss: 0.5256 | Val Loss: 0.8219
Train Recall: 0.7997 | Val Recall: 0.5202
------------------------------------------------------------

Эпоха 2/30
Train Loss: 0.4522 | Val Loss: 1.1818
Train Recall: 0.8258 | Val Recall: 0.5556
------------------------------------------------------------

Эпоха 3/30
Train Loss: 0.4164 | Val Loss: 0.6007
Train Recall: 0.8384 | Val Recall: 0.7007
------------------------------------------------------------

Эпоха 4/30
Train Loss: 0.3879 | Val Loss: 0.5608
Train Recall: 0.8533 | Val Recall: 0.7530
------------------------------------------------------------

Эпоха 5/30
Train Loss: 0.3721 | Val Loss: 0.6535
Train Recall: 0.8578 | Val Recall: 0.6872
------------------------------------------------------------

Эпоха 6/30
Train Loss: 0.3677 | Val Loss: 0.7730
Train Recall: 0.8622 | Val Recall: 0.7049
------------------------------------------------------------

Эпоха 7/30
Train Loss: 0.3403 | Val Loss: 0.5834
Train Recall: 0.8719 | Val Recall: 0.7378
------------------------------------------------------------

Эпоха 8/30
Train Loss: 0.3232 | Val Loss: 0.5765
Train Recall: 0.8891 | Val Recall: 0.7184
------------------------------------------------------------

Эпоха 9/30
Train Loss: 0.3315 | Val Loss: 0.5636
Train Recall: 0.8779 | Val Recall: 0.6585
------------------------------------------------------------

Эпоха 10/30
Train Loss: 0.3084 | Val Loss: 1.0595
Train Recall: 0.8824 | Val Recall: 0.4325
------------------------------------------------------------

Остановлен после 10 эпохи
2025-04-20 17:27:45.221 Python[56758:2280330] +[IMKClient subclass]: chose IMKClient_Legacy
2025-04-20 17:27:45.221 Python[56758:2280330] +[IMKInputSession subclass]: chose IMKInputSession_Legacy
